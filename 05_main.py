...
# 各Modelを取得
generator_model, _, _ = generator(en_seq_len, ja_seq_len, en_vocab_size, ja_vocab_size)
...
# validデータの翻訳 & 保存
translate(detokenizer_en, detokenizer_ja, x_valid, y_valid, ja_seq_len)
